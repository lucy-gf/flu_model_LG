...
cluster_mcmc <- function(k, epidemic_to_run){ # k %in% 1:7
  ...
  global_index <<- 1
  output <- custom_inference_sep_bt(
...
a <- 5 # CHANGE THIS TO CHANGE EXEMPLAR COUNTRY
...
saveRDS(results, file = paste0("command_line_runs/", strain, '_bt/', sel_cntr,"_epid",
                               epidemic_to_run, "_",
...
saveRDS(results2, file = paste0("command_line_runs/", strain, '_bt/', sel_cntr,"_epid",
                               epidemic_to_run, "_",
                               post_size, "_", thinning_steps, "_", burn_in, ".rds"))
...
saveRDS(results3, file = paste0("command_line_runs/", strain, '_bt/', sel_cntr,"_epid",
                                epidemic_to_run, "_",
                                post_size, "_", thinning_steps, "_", burn_in, ".rds"))
...
saveRDS(results4, file = paste0("command_line_runs/", strain, '_bt/', sel_cntr,"_epid",
                                epidemic_to_run, "_",
                                post_size, "_", thinning_steps, "_", burn_in, ".rds"))
...
saveRDS(results5, file = paste0("command_line_runs/", strain, '_bt/', sel_cntr,"_epid",
                                epidemic_to_run, "_",
                                post_size, "_", thinning_steps, "_", burn_in, ".rds"))
...
results6 <- cluster_mcmc(a, epidemic_to_run)

saveRDS(results6, file = paste0("command_line_runs/", strain, '_bt/', sel_cntr,"_epid",
                                epidemic_to_run, "_",
                                post_size, "_", thinning_steps, "_", burn_in, ".rds"))

...
for(c_number in 1:7){
  ...
  if(file.exists(paste0('data/vacc_output/nat_ann_', c_code, '.Rdata'))){
...
save(nat_ann, file = paste0('data/vacc_output/nat_ann.Rdata'))
save(global_weekly, file = paste0('data/vacc_output/global_weekly.Rdata'))

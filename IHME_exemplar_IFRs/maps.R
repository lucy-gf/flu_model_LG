...
ihme_data <- read_xlsx('IHME_exemplar_IFRs/extracted_data/Lancet_Resp_Med_2018_Influenza_LRTI_burden_table1.xlsx')
...
ggsave(paste0("IHME_exemplar_IFRs/maps/IHME_mort.png"),
...
ggsave(paste0("IHME_exemplar_IFRs/maps/exemplars.png"),
       width=26,height=16,units="cm")

### CDC mortality rates

cdc_data <- read_xlsx('IHME_exemplar_IFRs/extracted_data/Lancet_CDC_2018_Influenza_mortality_Table_S6.xlsx')
...
write_csv(cdc_data, 'IHME_exemplar_IFRs/extracted_data/Clean_Lancet_CDC_2018_Influenza_mortality_Table_S6.csv')
...
ggsave(paste0("IHME_exemplar_IFRs/maps/CDC_mort_u65.png"),
       width=30,height=16,units="cm")
...
ggsave(paste0("IHME_exemplar_IFRs/maps/CDC_mort_6574.png"),
       width=30,height=16,units="cm")
...
ggsave(paste0("IHME_exemplar_IFRs/maps/CDC_mort_o75.png"),
       width=30,height=16,units="cm")
...
ggsave(paste0("IHME_exemplar_IFRs/maps/ITZs.png"),
...
# save(annual_inc_l, file="IHME_exemplar_IFRs/data/annual_inc_l")

load("IHME_exemplar_IFRs/data/annual_inc_l")
...
ggsave(paste0("IHME_exemplar_IFRs/maps/no_vacc_attack_rates.png"),
       width=30,height=16,units="cm")

...
ggsave(paste0("IHME_exemplar_IFRs/plots/exemplar_cases.png"),
...
ggplot(cases_cum_cis_wide) +
  ...
  theme(text=element_text(size=14)) + labs(fill = 'Strain', col='Strain') +
  scale_x_date(date_labels="%Y",breaks="1 year",expand=expansion(0.01,0)) 
ggsave(paste0("IHME_exemplar_IFRs/plots/exemplar_cumcases.png"),
       width=26,height=24,units="cm")
...
ggplot(cases_fin_cis_wide) +
  ...
  scale_x_date(date_labels="%Y",breaks="1 year",expand=expansion(0.01,0)) 
ggsave(paste0("IHME_exemplar_IFRs/plots/exemplar_cumcasesagg.png"),
       width=26,height=24,units="cm")
...
ggsave(paste0("IHME_exemplar_IFRs/plots/exemplar_attack_rates.png"),
       width=26,height=24,units="cm")
